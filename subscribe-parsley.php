...
<!--    <script src="js/subscribe.js"></script>-->
    <script src="js/subscribe-parsley.js"></script>
    <style>
        label.error {
            color: crimson;
        }
...
<form name="frm" class="js-subscribe-form" data-parsley-validate>
    ...
    <div class="radio">
        <label>
            <input name="gubun" value="신규" type="radio" >
            신규
        </label>
        <label>
            <input name="gubun" value="연장" type="radio" >
            연장
        </label>
    ...
    <h3>암호</h3>
    <input type="password" name="pw" id="pw" data-parsley-range="[4, 20]" data-parsley-group="block1"/>
    <br/>
    <input type="password" name="pw2" id="pw2" data-parsley-range="[4, 20]" data-parsley-group="block2"/>
    <label class="error" for="pw"></label>

    <h3>*신청인</h3>

    <div class="subscription-name long-input">
        <input class="typing-field" id="OrdNm" type="text" name="OrdNm" data-required="true">
    </div>


    <h3>*소속(직장/학교 등) </h3>

    <div class="long-input"><input class="typing-field" id="sosok" type="text" name="sosok" data-required="true"></div>


    <h3>*연락처</h3>

    <div class="long-input"><input class="typing-field" id="RcpPhone" type="tel" name="RcpPhone" data-required="true"></div>


    <h3>*E-mail</h3>

    <div class="long-input"><input class="typing-field" id="UserEmail" type="email" name="UserEmail" data-required="true"></div>
    ...
    <div class="radio subscription-country">
        <label>
            <input name="domestic" value="국내" type="radio" data-required="true">
            국내
        </label>
        <label>
            <input name="domestic" value="해외" type="radio" data-required="true">
            해외
        </label>
    ...
    <div class="short-input address">
        ...
        <input class="typing-field" type="tel" name="zipcode" data-required="true"/>
    </div>

    <h3>*주소 :</h3>

    <div class="long-input address address-input"><input class="typing-field" name="address1" id="address1" size="50" type="text" data-required="true"></div>
    <div class="long-input address address-input"><input class="typing-field" name="address2" id="address2" size="50" type="text" data-required="true"></div>
    ...
    <div class="radio pay-method">
        ...
        <div class="mtj is-hidden">
            ...
            <div class="long-input subscription-payer">
                <input class="typing-field" name="bank_name" id="bank_name" type="text" data-required="true">
            </div>
