...
<body>
<form name="frm" class="js-subscribe-form">
    ...
    <div class="radio">
        <label>
            <input name="gubun" value="신규" type="radio" required="">
            신규
        </label>
        <label>
            <input name="gubun" value="연장" type="radio" required="">
            연장
        </label>
    ...
    <div class="radio subscription-country">
        <label>
            <input name="domestic" value="국내" type="radio" required="">
            국내
        </label>
        <label>
            <input name="domestic" value="해외" type="radio" required="">
            해외
        </label>
